...
class BitcoinTestFramework(object):
    ...
    def main(self):
        ...
        parser.add_option("--srcdir", dest="srcdir", default="../../src",
                          help="Source directory containing smartcoind/bitcoin-cli (default: %default)")
...
# Test framework for doing p2p comparison testing, which sets up some smartcoind
# binaries:
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("BITCOIND", "smartcoind"),
