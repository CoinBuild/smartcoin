...
Value getgenerate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "It is set with the command line argument -gen (or smartcoin.conf setting gen)\n"
...
// NOTE: Unlike wallet RPC (which use SMC values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
