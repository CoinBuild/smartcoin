...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Smartcoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  smartcoin-cli [options] <command> [params]  " + _("Send command to Smartcoin Core") + "\n" +
                  "  smartcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  smartcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
