...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Smartcoin Core smartcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  smartcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smartcoin transaction") + "\n" +
              "  smartcoin-tx [options] -create [commands]   " + _("Create hex-encoded smartcoin transaction") + "\n" +
              "\n";
