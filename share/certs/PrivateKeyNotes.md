...
allowing somebody to distribute a Bitcoin-Qt.app or smartcoin-qt-setup.exe with a valid
...
that the smartcoin-qt.exe file inside the installer had not been tampered with.
